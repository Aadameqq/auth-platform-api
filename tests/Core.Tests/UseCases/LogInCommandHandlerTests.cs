...
//     {
//         var result = await commandHandler.Execute("invalid-email", existingAccount.Password);
//
...
//     {
//         var result = await commandHandler.Execute(existingAccount.Email, "invalid-password");
//
//         Assert.True(result.IsFailure);
...
//     {
//         var result = await commandHandler.Execute(existingAccount.Email, existingPlainPassword);
//
//         Assert.True(result.IsFailure);
...
//             .Returns(generatedTokenPair);
//
//         await commandHandler.Execute(existingAccount.Email, existingPlainPassword);
//
